...
const router = createRouter({
  ...
  routes: [
    ...
    // 签到模块
    {
      ...
      meta: { title: '今日签到', requiresAuth: true, roles: ['admin', 'teacher'] }
    },
    {
      path: '/attendance/history',
      name: 'AttendanceHistory',
      component: () => import('../pages/AttendanceHistory.vue'),
      meta: { title: '签到记录', requiresAuth: true, roles: ['admin'] }
    },
    {
    ...
    },
    {
      ...
      meta: { title: '统计分析', requiresAuth: true, roles: ['admin', 'teacher'] }
    },
    {
      path: '/stats/business',
      name: 'StatsBusiness',
    ...
    // 数据管理
    {
      ...
      meta: { title: '数据导出', requiresAuth: true, roles: ['admin'] }
    },
    {
      path: '/data/backup',
      name: 'DataBackup',
      component: () => import('../pages/DataBackup.vue'),
      meta: { title: '数据备份', requiresAuth: true, roles: ['admin'] }
    },
    // 设置
    {
      path: '/settings',
